...
# @Last Modified time: 2017-01-03 18:12:39
...
# name = '/tmp/mountaincar-v0-baseline-pg8'
...
while episode_number < episodes:
  ...
  # action = 1 if np.random.uniform() < aprob[0] else 0 # roll the dice!
  action = sample(aprob)
...
# with open('v3.txt','a') as f_handle:
# 	np.savetxt(f_handle, history, newline=" ", fmt='%.1f')
